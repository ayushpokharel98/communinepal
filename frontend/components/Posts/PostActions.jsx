...
const PostActions = ({ post, onLike, onComment, onShare }) => (
  <div className="flex divide-x divide-gray-700">
    <button
      ...
      className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm transition-colors hover:bg-gray-700 ${
        post.is_liked ? "text-red-400" : "text-gray-400 hover:text-white"
      }`}
    >
    ...
    <button
      ...
      className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm transition-colors hover:bg-gray-700 ${
        post.is_shared ? "text-blue-400" : "text-gray-400 hover:text-white"
      }`}
    >
      <Share size={16} />
